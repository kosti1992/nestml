...
public class LEMSCollectorStaticElementsTest extends ModelbasedTest{
  ...
  public void testGenerateLEMS() throws Exception {
    ...
    Assert.assertEquals("0",testant.getListOfNeurons().get(0).getConstantsList().get(0).getValue());
    Assert.assertEquals("mV",testant.getListOfNeurons().get(0).getConstantsList().get(0).getUnit());
    Assert.assertEquals(Dimension.DimensionName.voltage,
        testant.getListOfNeurons().get(0).getConstantsList().get(0).getDimension());
    ...
    Assert.assertEquals(Dimension.DimensionName.voltage,
        testant.getListOfNeurons().get(0).getDerivedParametersList().get(0).getDimension());
    Assert.assertEquals("-CON70mV-E_L",
        testant.getListOfNeurons().get(0).getDerivedParametersList().get(0).getDerivationInstruction());
